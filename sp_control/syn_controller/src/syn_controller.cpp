...
namespace syn_controller
{
  ...
  { 
    ...
    if (has_friction_)
    {
      if (has_gravity_)
      {
        if ((cmd_ - ctrl_left_.joint_.getPosition()) > 0.012)
        {
        ...
        else if ((cmd_ - ctrl_left_.joint_.getPosition()) < -0.012)
        {
          ctrl_left_.joint_.setCommand(ctrl_left_.joint_.getCommand() - friction_ + gravity_);
          ctrl_right_.joint_.setCommand(ctrl_right_.joint_.getCommand() - friction_ + gravity_);
        }
        ...
        {
          double eff_left = (cmd_ - ctrl_left_.joint_.getPosition()) / 0.012;
          double eff_right = (cmd_ - ctrl_right_.joint_.getPosition()) / 0.012;
          ctrl_left_.joint_.setCommand(ctrl_left_.joint_.getCommand() + eff_left * friction_ + gravity_);
      ...
      else
      {
        ...
        {
          double eff_left = (cmd_ - ctrl_left_.joint_.getPosition()) / 0.008;
          double eff_right = (cmd_ - ctrl_right_.joint_.getPosition()) / 0.008;
          ctrl_left_.joint_.setCommand(ctrl_left_.joint_.getCommand() + eff_left * friction_);
          ctrl_right_.joint_.setCommand(ctrl_right_.joint_.getCommand() + eff_right * friction_);
