...
namespace manipulator_control
{
    ...
    bool Manipulator::init()
    {
        ...
        move_group_interface.setEndEffectorLink("link7");
        // please don't use move_group_interface.setGoalJointTolerance(),
        // which could cause every joints to twitch even if you only want to control a single joint
    ...
    {
        current_pose = move_group_interface.getCurrentPose("link7").pose;
