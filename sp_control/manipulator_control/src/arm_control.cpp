...
namespace manipulator_control
{
    ...
    bool Manipulator::init()
    {
        ...
        grip_group_interface.setPoseReferenceFrame("link6");
    ...
    void Manipulator::write(const geometry_msgs::PoseStamped &target_pose_)
    {
    ...
    /*void Manipulator::write(std::vector<double> target_state_)
    {
