...
namespace gpios_controller
{
    ...
    class Engineer : public controller_interface::MultiInterfaceController<sp_control::GpioCommandInterface>
    {
    public:
        Engineer() = default;
    ...
    protected:
        ...
        gpio_controller::GpioController ctrl_pump_;

        gpio_controller::GpioController ctrl_rod_;

        bool pump_msg_ = false;
