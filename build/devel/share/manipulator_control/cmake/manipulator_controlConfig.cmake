...
if("TRUE" STREQUAL "TRUE")
  set(manipulator_control_SOURCE_PREFIX /home/adminpc/catkin_ws/src/sp_control/manipulator_control)
  set(manipulator_control_DEVEL_PREFIX /home/adminpc/catkin_ws/src/build/devel)
  ...
  set(manipulator_control_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/adminpc/catkin_ws/src/sp_control/manipulator_control/include " STREQUAL " ")
  set(manipulator_control_INCLUDE_DIRS "")
  set(_include_dirs "/home/adminpc/catkin_ws/src/sp_control/manipulator_control/include")
  if(NOT "https://github.com/ros-planning/moveit2_tutorials/issues " STREQUAL " ")
    set(_report "Check the issue tracker 'https://github.com/ros-planning/moveit2_tutorials/issues' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT "https://moveit.picknik.ai " STREQUAL " ")
    set(_report "Check the website 'https://moveit.picknik.ai' for information and consider reporting the problem.")
  else()
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'manipulator_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/adminpc/catkin_ws/src/sp_control/manipulator_control/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(manipulator_control_EXPORTED_TARGETS ${${manipulator_control_dep}_EXPORTED_TARGETS})
endforeach()
